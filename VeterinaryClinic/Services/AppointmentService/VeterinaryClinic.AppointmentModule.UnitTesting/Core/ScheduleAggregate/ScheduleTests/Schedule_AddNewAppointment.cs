...
namespace VeterinaryClinic.AppointmentModule.UnitTesting.Core.ScheduleAggregate.ScheduleTests
{
    public class Schedule_AddNewAppointment
    {
        private readonly Guid _scheduleId = Guid.Parse("4a17e702-c20e-4b87-b95b-f915c5a794f7");
        private readonly DateTimeOffsetRange _dateRange = DateTimeOffsetRange.Create(DateTime.Today, DateTime.Today.AddDays(1));
        ...
        public void AddsAppointmentScheduledEvent()
        {
            ...
            var lisaDateRange = DateTimeOffsetRange.Create(lisaStartTime, lisaEndTime);
            ...
            var mimiDateRange = DateTimeOffsetRange.Create(mimiStartTime, mimiEndTime);
