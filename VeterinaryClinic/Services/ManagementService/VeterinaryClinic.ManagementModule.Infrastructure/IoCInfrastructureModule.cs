...
using VeterinaryClinic.ManagementModule.Infrastructure.IntegrationMapper;
using VeterinaryClinic.ManagementModule.Infrastructure.MessagingRabbit;
...
namespace VeterinaryClinic.ManagementModule.Infrastructure
{
    public class IoCInfrastructureModule : Module
    {
        ...
        private static void RegisterIntegrationEventMapper(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<ManagementIntegrationEventMapper>()
                   .As<IManagementIntegrationEventMapper>()
                   .SingleInstance();
        }
            ...
            if (bool.Parse(enableBus))
            {
                builder.RegisterType<AppDbContext>()
                    ...
                    .WithParameter((pi, ctx) => pi.ParameterType == typeof(IIntegrationEventMapper) &&
                                                pi.Name == "eventMapper", (pi, ctx) => ctx.Resolve<IManagementIntegrationEventMapper>());
            }
            else
            {
                builder.RegisterType<AppDbContext>()
        ...
        public static void ConfigureEventBus(IServiceProvider serviceProvider)
        {        
        }
